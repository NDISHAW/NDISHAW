...
const Resume = (props) => {
  ...
  //STATIC RESUME DATA FOR SKILLS
  const Softwares = [
    { skill: "Ms Word", ratingPercentage: 90 },
    { skill: "Ms Excell", ratingPercentage: 95 },
    { skill: "Ms Access", ratingPercentage: 85 },
    { skill: "Software & H/W Maintenance", ratingPercentage: 60},
  ];
